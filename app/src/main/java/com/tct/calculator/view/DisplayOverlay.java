 ...
 */
public class DisplayOverlay extends FrameLayout{ // MODIFIED by qiong.liu1, 2017-04-07,BUG-4452809
    /**
    ...
    private int mFator; // MODIFIED by qiong.liu1, 2017-04-19,BUG-4452809
    ...
    protected void onFinishInflate() {
        ...
        mRecyclerView = (MyRecyclerView) findViewById(R.id.historyRecycler);
        ...
        mFator = this.getResources().getInteger(R.integer.display_height_fator); // MODIFIED by qiong.liu1, 2017-04-19,BUG-4452809
        //TS:kaifeng.lu 2016-01-22 Calculator BUGFIX_ 1273635  ADD_S
        mHistoryBlankView = findViewById(R.id.blank_space);
        //TS:kaifeng.lu 2016-01-22 Calculator BUGFIX_ 1273635  ADD_E
    }
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (dy < 0) {
                    Log.d(TAG, "onIntercept dy < 0 isScrolledToEnd:" + isScrolledToEnd() + "    state:" + state + "   return:" + (isScrolledToEnd() && state != TranslateState.COLLAPSED)); // MODIFIED by qiong.liu1, 2017-03-30,BUG-3621966
                    //replace 1
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        Log.d(TAG, "onTouchEvent " + action); // MODIFIED by qiong.liu1, 2017-03-30,BUG-3621966
        switch (action) {
            case MotionEvent.ACTION_DOWN:
                break;
            case MotionEvent.ACTION_MOVE:
...
//                    mHistoryBlankView.setScaleY(factor);
    ...
    public void getLimitMaxTranslation() {
        //TS:kaifeng.lu 2016-01-22 Calculator BUGFIX_ 1273635  MOD_S
        limitMaxTranslation = (int) (getParentHeight() -(mFator/100.0) * getDisplayHeight()); // MODIFIED by qiong.liu1, 2017-04-19,BUG-4452809
...
//        mHistoryBlankView.setScaleY(factor);
    ...
    public MyRecyclerView getHistoryView() {
