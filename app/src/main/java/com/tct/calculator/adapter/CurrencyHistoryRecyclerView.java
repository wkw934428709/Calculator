 ...
 */
public class CurrencyHistoryRecyclerView extends RecyclerView{
    public CurrencyHistoryRecyclerView(Context context) {
        super(context);
    }
    ...
    public CurrencyHistoryRecyclerView(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public int getMyMeasureHeight(){
        int sum = 0;
        CurrencyHistoryAdapter ha=(CurrencyHistoryAdapter)this.getAdapter();
